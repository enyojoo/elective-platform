        ...
        <form action={handleSignIn}>
          <Card>
            <CardHeader className="space-y-1 text-center">
              ...
              <CardTitle className="text-2xl">{t("manager.login.title")}</CardTitle>
              <CardDescription>{t("manager.login.description")}</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <Button type="submit" className="w-full" disabled={isLoading}>
                {isLoading ? t("manager.login.loading") : t("manager.login.submit")}
              </Button>
            </CardContent>
          </Card>
        </form>
        <div className="mt-4 text-center text-sm">
          {t("manager.login.noAccount")}{" "}
          <Link href="/manager/signup" className="underline">
            {t("manager.login.signUp")}
          </Link>
        </div>
