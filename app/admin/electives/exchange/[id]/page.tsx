...
export default async function AdminExchangeElectivePackPage({ params }: { params: { id: string } }) {
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            <Link href="/admin/electives/exchange" className="hover:text-foreground">
              Exchange Programs
            </Link>
            <span>/</span>
            <span>{pack.name}</span>
        ...
        <div className="flex gap-2">
          <Button variant="outline" asChild>
            <Link href={`/admin/electives/exchange/${params.id}/edit`}>
