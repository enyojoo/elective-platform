...
export default function AdminExchangePackDetailPage() {
    ...
    return (
      <div className="container mx-auto p-6">
        <div className="text-center">
          ...
          <Button onClick={() => router.push("/admin/electives/exchange")}>
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Button variant="ghost" onClick={() => router.push("/admin/electives/exchange")}>
            <ArrowLeft className="mr-2 h-4 w-4" />
            Back to Exchange Electives
          </Button>
        </div>
        <div className="flex gap-2">
          <Button variant="outline" onClick={() => router.push(`/admin/electives/exchange/${pack.id}/edit`)}>
