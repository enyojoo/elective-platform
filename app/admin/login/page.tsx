...
const DEFAULT_LOGO_URL = "/images/elective-pro-logo.svg"
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>{t("auth.login.adminSubtitle")}</CardDescription>
          </CardHeader>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/admin/forgot-password" prefetch={false} className="text-sm text-primary hover:underline">
